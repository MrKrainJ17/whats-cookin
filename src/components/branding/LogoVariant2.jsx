// Variation 2 — Two-tone Terracotta
// Same anatomy as V1, but steam runs in terracotta (#D2691E) so it feels
// alive. Pot stays in deep warm brown.
export default function LogoVariant2({ size = 64, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
